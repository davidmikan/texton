...
#                 del objects.world.rooms[destination] # delete uncessary copy of active room
...
# def unlockroom(id):
#     print(objects.player.inventory)
#     print(objects.world.connections[id].properties['key'])
